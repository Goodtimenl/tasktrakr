...
export default function marginHorizontal() {
  ...
  // Methode d'ajout de fonts dans le projet y'a un async car soit disant que je l'utilisais avant qu'elle soit chargee...
  useEffect(() => {
